      ...
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <a href="{{ url('checkout/1') }}" class="btn btn-block btn-dark text-uppercase">Beli Sekarang</a>
          </div>
        </div>
      </div>
      <!-- Plus Tier -->
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <a href="{{ url('checkout/2') }}" class="btn btn-block btn-dark text-uppercase">Beli Sekarang</a>
          </div>
        </div>
      </div>
      <!-- Pro Tier -->
      <div class="col-lg-4">
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{ url('checkout/3') }}" class="btn btn-block btn-dark text-uppercase">Beli Sekarang</a>
          </div>
        </div>
      </div>
    </div>
